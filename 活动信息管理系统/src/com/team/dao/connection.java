...
public class connection{
	...
	final static String DB_URL = "jdbc:mysql://localhost:3306/xiang_mu?useUnicode=true&characterEncoding=utf-8&useSSL=false";
	final static String DB_USER = "root";
	final static String PASSWORD = "qwe12345";
